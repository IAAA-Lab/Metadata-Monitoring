...
This web portal provides a user interface that facilitates the access to the implementation of these two quality assessment methods: MQA and ISO19157. Among other features, it allows the scheduling of the monitoring of an open data portal, the graphical presentation of the evaluation results, and the export of these results according to the [Data Quality Vocabulary (DQV) vocabulary](https://www.w3.org/TR/vocab-dqv/) in turtle format. 
